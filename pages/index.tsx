    ...
    <div style={{ width: '100%' }}>
      ...
      <div style={sectionStyle}>
        ...
        <p style={{ maxWidth: '550px', paddingBottom: '30px', ...pStyle }}>
          This section demonstrates the power of dynamic imports. Every Markdown file under{' '}
          <code>/md/blog</code> is automatically parsed into a structured TypeScript object and
          available in the <code>props.posts</code> array. These blog post "cards" are implemented
          in the
      ...
      <div style={{ ...sectionStyle }}>
        ...
        >
          Below is the README.md for devii. It was imported and rendered using Next.js dynamic
          imports. The rest of this page (including this paragraph) are rendered with React. You can
          also read the README on GitHub at{' '}
          <a href="https://github.com/vriad/devii">https://github.com/vriad/devii</a>.
        </p>
      </div>
      <div
        style={{
      ...
      <div style={sectionStyle}>
        <h2 style={{ margin: '4px 0px', fontSize: '22pt', paddingBottom: '30px' }}>Get started</h2>
        <button
          style={{
            padding: '10px 30px',
